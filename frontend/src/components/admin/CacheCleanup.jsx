  ...
  return (
    <>
            ...
            <div className="space-y-4">
              ...
              <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                <p className="text-sm text-gray-600">
                  Clearing the cache will free up system resources but may cause
                  a brief interruption in AI services while the model reloads.
                </p>
              </div>
            </div>
          </div>
      ...
      <ConfirmDialog
        ...
        description="Are you sure you want to clear the AI model cache? This will cause a brief interruption in AI services while the model reloads."
